...
echo "  samples  : ${NOISE_ROLLOUTS_PER_ENV} rollouts/environment"
echo "  random   : ${ROLLOUT_RANDOMIZATION} (legacy checkpoints -> noise)"
echo "  z grid   : ${LATENT_SAMPLING_GRID}x${LATENT_SAMPLING_GRID}"
