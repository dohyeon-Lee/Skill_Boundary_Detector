...
# Usage: ./submit_train.sh [arch0|arch0_1|arch0_2|arch0_2_sep|arch0_3|arch0_adaRMS|arch0_token|arch0_token_iso|arch1_1|arch1_2|arch1_3|arch2_1|arch2_2|arch3|arch4]
...
if [ "$#" -gt 1 ]; then
  echo "Usage: $0 [arch0|arch0_1|arch0_2|arch0_2_sep|arch0_3|arch0_adaRMS|arch0_token|arch0_token_iso|arch1_1|arch1_2|arch1_3|arch2_1|arch2_2|arch3|arch4]" >&2
  exit 2
fi
ARCHITECTURE_OVERRIDE="${1:-${STAGE1_ARCHITECTURE_OVERRIDE:-}}"
if [ -n "${ARCHITECTURE_OVERRIDE}" ]; then
  case "${ARCHITECTURE_OVERRIDE}" in
    arch0|arch0_1|arch0_2|arch0_2_sep|arch0_3|arch0_adaRMS|arch0_token|arch0_token_iso|arch1_1|arch1_2|arch1_3|arch2_1|arch2_2|arch3|arch4) ;;
    *)
