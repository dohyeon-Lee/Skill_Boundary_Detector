...
# Usage: ./submit_train.sh [arch0|arch1_1|arch1_2|arch1_3|arch2_1|arch2_2|arch3|arch4]
...
if [ "$#" -gt 1 ]; then
  echo "Usage: $0 [arch0|arch1_1|arch1_2|arch1_3|arch2_1|arch2_2|arch3|arch4]" >&2
  exit 2
fi
ARCHITECTURE_OVERRIDE="${1:-${STAGE1_ARCHITECTURE_OVERRIDE:-}}"
if [ -n "${ARCHITECTURE_OVERRIDE}" ]; then
  case "${ARCHITECTURE_OVERRIDE}" in
    arch0|arch1_1|arch1_2|arch1_3|arch2_1|arch2_2|arch3|arch4) ;;
    *)
