...
Usage:
  python verify_image_orientation.py --set langgap_56_full_full
  python verify_image_orientation.py --set langgap_6_smoke --reference dataset_filtered/libero_90_full_full
"""
