...
#   config       : ../../split_dataset/training_dataset_config.yaml
# Reference model:
#   none
# Outputs:
...
Examples:
  python src/ensure_quantile_stats.py --dataset libero_90_full_full
  python src/ensure_quantile_stats.py --dataset libero_10_full_full --overwrite
"""
...
GENERATE_DIR = THIS_DIR.parent.parent.parent
SPLIT_DIR = GENERATE_DIR / "split_dataset"
CONFIG_PATH = SPLIT_DIR / "training_dataset_config.yaml"
