...
bottom-to-top). Datasets converted before src/convert_original_libero_to_lerobot.py applied the
...
Usage:
  python src/rotate180_postprocess.py --root /path/to/dataset/libero_90_full_full [--workers 6]
"""
