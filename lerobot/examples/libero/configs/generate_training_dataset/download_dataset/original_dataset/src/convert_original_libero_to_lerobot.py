...
#   config        : ../original_dataset_config.yaml
# Reference model:
#   none
# Outputs:
...
Examples:
  python src/convert_original_libero_to_lerobot.py --suite libero_10
  python src/convert_original_libero_to_lerobot.py --suite libero_90 --output-name libero_90_full_full
...
DATASET_DIR = THIS_DIR.parent
GENERATE_DIR = DATASET_DIR.parent.parent
SPLIT_DIR = GENERATE_DIR / "split_dataset"
PROJECT_ROOT_FALLBACK = THIS_DIR.parents[7]
CONFIG_PATH = DATASET_DIR / "original_dataset_config.yaml"

sys.path.insert(0, str(SPLIT_DIR / "src"))
try:
