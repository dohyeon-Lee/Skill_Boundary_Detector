...
`../../original_dataset/src/rotate180_postprocess.py`는 원본 HDF5 경로에만 해당).

## Run

```bash
cd lerobot/examples/libero/configs/generate_training_dataset/download_dataset/filtered_dataset
