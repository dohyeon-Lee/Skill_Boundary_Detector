...
Usage:
    python configs/train_skills/FSQ_new/src/train_FSQ_new.py \
...
class Args:
    ...
    """End-weight regime A only; B/C and context auxiliary losses stay uniform."""
...
def main(args: Args) -> None:
    from FSQ_new import SplineFSQAEConfig, prepare_encoder_trajectory, train_spline_fsqae
    ...
    if args.encoder_input_mode == "optimal":
        from FSQ_new import encoder_start_eef_pose
    ...
    cfg = SplineFSQAEConfig(
        ...
        context_queries=args.context_queries,
        context_layers=args.context_layers,
        context_heads=args.context_heads,
        context_dropout=args.context_dropout,
        a_skill_scale=args.a_skill_scale,
        b_skill_scale=args.b_skill_scale,
        c_skill_scale=args.c_skill_scale,
        b_image_scale=args.b_image_scale,
        c_image_scale=args.c_image_scale,
        c_goal_scale=args.c_goal_scale,
        ...
        wrong_goal_relative_margin=args.wrong_goal_relative_margin,
