...
def build_settings(config_path: str | None = None) -> dict:
    ...
    exclude = as_list(get_value(cfg, "fsq_eval_exclude_nodes", []))
    return {
        ...
        "fsq_eval_partition":      ",".join(as_list(get_value(cfg, "fsq_eval_partition", ["debug"]))) or "debug",
        "fsq_eval_qos":            str(get_value(cfg, "fsq_eval_qos", "base_qos")),
        ...
        "fsq_eval_nodelist":       str(get_value(cfg, "fsq_eval_nodelist", "")),
