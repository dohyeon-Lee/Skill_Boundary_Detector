...
from lerobot.policies.skillVLA_stage0_pretrain.configuration_skillVLA_stage0_pretrain import (
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    elif name == "skill_vla_stage0_pretrain":
        from lerobot.policies.skillVLA_stage0_pretrain.modeling_skillVLA_stage0_pretrain import (
            SkillVLAStage0PretrainPolicy,
        )

        return SkillVLAStage0PretrainPolicy
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "skill_vla_stage0_pretrain":
        return SkillVLAStage0PretrainConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    """
    if isinstance(policy_cfg, SkillVLAStage0PretrainConfig):
        ...
        from lerobot.policies.skillVLA_stage0_pretrain.processor_skillVLA_stage0_pretrain import (
            make_skill_vla_stage0_pretrain_pre_post_processors,
        )
        ...
        return make_skill_vla_stage0_pretrain_pre_post_processors(
            config=policy_cfg,
...
def make_policy(
    ...
    if not cfg.input_features:
        if isinstance(cfg, DiffusionConfig) and cfg.use_dino_features:
            cfg.input_features = {key: ft for key, ft in features.items() if key == OBS_STATE}
        else:
